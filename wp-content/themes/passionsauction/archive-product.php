...
<section class="auction-list">
	<div class="customcontainer">
		<div class="heading-with-searchgrid">
			<div class="heading"><h2>Welcome to Market Place</h2></div>
		...
		<div class="archieve-auction">
			...
			<div class="filtersidebar">
				...
				<div class="filterblocks">
					...
					<input type="hidden" id="checked_productcategory" value="<?php echo $selectedcat; ?>">
					...
					<div class="filterblock-wrapper">
						...
						if (!empty($terms)) {
						    ...
						    foreach ($terms as $term) {
						        ...
						        echo '<label>';						        
								echo '<input type="checkbox" value="' . $term->term_id . '" name="productcategory" '.$chst.'>';
					...
					<div class="filterblock-wrapper">
						...
						<div class="collapse" id="Price">
					      	<div class="filterlist-item price">
					      		<input type="text" placeholder="$ Min" id="productminprice" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control">
					      		<input type="text" placeholder="$ Max" id="productmaxprice" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control">
					      	</div>
					    </div>
					</div>
