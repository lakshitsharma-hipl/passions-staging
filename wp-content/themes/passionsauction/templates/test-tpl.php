...
<?php echo do_shortcode('[contact-form-7 id="793e22a" title="TestForm"]'); ?>
...
<script>
  jQuery(document).ready(function($) {
    ...
    // Set the value of the hidden field to the current page ID
    $('#pageidfield').val(currentPageID);
});
</script>
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <body id="pagehtmlblock" class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ecf0f1;color: #000000">
...
<img src="https://m3.promofeatures.com/annc.gif" border="0" alt="https://promofeatures.com" />
    ...
    <table id="u_content_text_3" style="font-family:'Raleway',sans-serif;padding: 10px 0;display: block; " role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody>
        <tr>
          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Raleway',sans-serif;" align="left">
           
      <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="line-height: 140%; font-size:20px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspen disse ultrices gravida. Risus commodo viverra </p>
      </div>
          ...
          <div style="font-size: 12px; line-height: 140%; text-align: center; word-wrap: break-word; margin: 20px 0;">
           <table width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td align="center">
                        <a href="http://link.countdownmail.com/3aysqz">
                            <img src="http://i.countdownmail.com/3aysqz.gif" style="display:inline-block!important;width:100%!important;max-width:309px!important;" border="0" alt="countdownmail.com"/>
                        </a>
                    </td>
                </tr>
            </tbody>
